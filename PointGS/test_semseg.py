...
sys.path.append(os.path.join(ROOT_DIR, 'log/sem_seg/2021-11-23_06-56'))    ##########################
...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str, default='2021-11-23_06-56',  help='experiment root')   ###########################
...
def main(args):
    ...
    root = '/Data_SSD/Chenru/pointdataset/Stanford3dDataset_v1.2_Aligned_Version/stanford_indoor3d/'  #################################
